...
def create_mock_exa_environment(mock_meta: MockMetaData,
                                bfs_connections: dict[str, Connection]) -> MockExaEnvironment:
    mock_exa = MockExaEnvironment(
        metadata=mock_meta,
        connections=bfs_connections)
    return mock_exa

def create_bfs_connections_with_token_con(bfs_conn_names: List[str],
...
def create_mock_exa_environment_with_token_con(
    ...
    bfs_connections = create_bfs_connections_with_token_con(bfs_conn_names,
