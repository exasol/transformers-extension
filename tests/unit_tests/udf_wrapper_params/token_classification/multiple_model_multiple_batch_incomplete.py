...
class MultipleModelMultipleBatchIncomplete:
    ...
    tokenizer_model_output_df_model1 =  [make_model_output_for_one_input_row(number_entities=n_entities, word=token1,
                                                                     ...
                                                                     data_size]
    tokenizer_model_output_df_model2 =  [make_model_output_for_one_input_row(number_entities=n_entities, word=token2, # in first batch model is used for one input
                                                                     entity_group=entity_type2, score=score+0.1)] + \
                                        [make_model_output_for_one_input_row(number_entities=n_entities, word=token2, # in second batch model is used for one input
                                                                             entity_group=entity_type2, score=score + 0.1)]
