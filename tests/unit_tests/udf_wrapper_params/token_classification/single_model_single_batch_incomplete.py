...
class SingleModelSingleBatchIncomplete:
    ...
    output_data = [("bfs_conn1", "sub_dir1", "model1", "text", agg_strategy,
                    token_start, token_end, "text", "label1", 0.1, None)] * n_entities * data_size
    ...
    work_with_span_output_data = [("bfs_conn1", "sub_dir1", "model1", "text",token_docid,start,end, agg_strategy,
                    token_start, token_end, "text", "label1", 0.1, token_docid, start+token_start, start+token_end, None)] * n_entities * data_size
