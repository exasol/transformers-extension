...
from tests.unit_tests.udf_wrapper_params.token_classification.mock_token_classification import (
    MockPipeline,
...
class SingleBucketFSConnMultipleSubdirSingleModelNameSingleBatch:
    ...
    input_data = [
        (None, "bfs_conn1", "token_conn1", "sub_dir1", "model1", "text1", agg_strategy)
    ] * data_size + [
        (None, "bfs_conn1", "token_conn1", "sub_dir2", "model1", "text1", agg_strategy)
    ] * data_size
    output_data = [
        (
            "bfs_conn1",
