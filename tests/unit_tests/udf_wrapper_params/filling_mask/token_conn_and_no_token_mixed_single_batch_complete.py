...
def udf_wrapper():
    ...
    from tests.unit_tests.udf_wrapper_params.filling_mask. \
        token_conn_and_no_token_mixed_single_batch_complete import \
...
class TokenConnAndNoTokenMixedSingleBatchComplete:
    ...
    mock_factory = MockFillingMaskFactory({
        ...
        (PurePosixPath(base_cache_dir1, "sub_dir1", "model1"), False):
            MockFillingMaskModel(sequence="text valid 1", score=0.1, rank=1)
    })
