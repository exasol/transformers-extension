...
class MultipleModelMultipleBatchMultipleModelsPerBatch:
    ...
    mock_factory = MockFillingMaskFactory({
        ...
        PurePosixPath(base_cache_dir3, get_bucketfs_model_save_path("sub_dir3", ModelSpecificationString("model3"))):
            MockFillingMaskModel(sequence="text valid 3", score=0.3, rank=1),
        PurePosixPath(base_cache_dir4, get_bucketfs_model_save_path("sub_dir4", ModelSpecificationString("model4"))):
