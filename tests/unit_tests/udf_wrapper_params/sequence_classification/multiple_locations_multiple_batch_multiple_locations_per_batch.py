...
def udf_wrapper_text_pair():
    ...
    from tests.unit_tests.udf_wrapper_params.sequence_classification. \
        mock_sequence_tokenizer import MockSequenceTokenizer
    from tests.unit_tests.udf_wrapper_params.sequence_classification.\
        multiple_locations_multiple_batch_multiple_locations_per_batch import \
        MultipleModelLocationsMultipleBatchMultipleLocationsPerBatch as params
...
class MultipleModelLocationsMultipleBatchMultipleLocationsPerBatch:
    """
    multiple locations, multiple batch, multiple locations per batch
    """
    batch_size = 2
    data_size = 1
