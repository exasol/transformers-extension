...
class ErrorNotCachedSingleModelMultipleBatch:
    ...
    inputs_single_text = [(None, "bfs_conn1", "sub_dir1", "non_existing_model",
                           "My test text")] * data_size
    inputs_pair_text = [(None, "bfs_conn1", "sub_dir1", "non_existing_model",
                         "My text 1", "My text 2")] * data_size

    outputs_single_text = [("bfs_conn1", "sub_dir1", "non_existing_model",
                            "My test text", None, None, "Traceback"),
                           ("bfs_conn1", "sub_dir1", "non_existing_model",
                            "My test text", None, None, "Traceback"),
                           ("bfs_conn1", "sub_dir1", "non_existing_model",
                            "My test text", None, None, "Traceback"),
                           ("bfs_conn1", "sub_dir1", "non_existing_model",
    ...
    outputs_text_pair = [("bfs_conn1", "sub_dir1", "non_existing_model",
