...
class MultipleModelMultipleBatchComplete:
    ...
    inputs_single_text = \
        ...
        [(None, "sub_dir4", "model2", "My test text")] * data_size
    inputs_pair_text = \
        ...
        [(None, "sub_dir4", "model2", "My text 1", "My text 2")] * data_size
    ...
    outputs_single_text = \
        ...
        * data_size + \
        [("sub_dir4", "model2", "My test text", "label1", 0.21),
         ("sub_dir4", "model2", "My test text", "label2", 0.24),
         ("sub_dir4", "model2", "My test text", "label3", 0.26),
         ("sub_dir4", "model2", "My test text", "label4", 0.29)] \
        * data_size
    ...
    outputs_text_pair = \
        ...
        * data_size + \
        [("sub_dir4", "model2", "My text 1", "My text 2", "label1", 0.21),
         ("sub_dir4", "model2", "My text 1", "My text 2", "label2", 0.24),
         ("sub_dir4", "model2", "My text 1", "My text 2", "label3", 0.26),
         ("sub_dir4", "model2", "My text 1", "My text 2", "label4", 0.29)] \
        * data_size
