...
def udf_wrapper():
    ...
    from tests.unit_tests.udf_wrapper_params.question_answering.\
        multiple_locations_multiple_batch_complete \
        import MultipleModelLocationsMultipleBatchComplete \
        as params
...
class MultipleModelLocationsMultipleBatchComplete:
    """
    multiple locations, multiple batch, last batch complete
    """
    batch_size = 2
    data_size = 2
