...
def udf_wrapper():
    ...
    from tests.unit_tests.udf_wrapper_params.question_answering.\
        multiple_locations_single_batch_complete \
        import MultipleModelLocationsSingleBatchComplete \
        as params
...
class MultipleModelLocationsSingleBatchComplete:
    """
    multiple locations, single batch, last batch complete
    """
    batch_size = 8
    data_size = 2
