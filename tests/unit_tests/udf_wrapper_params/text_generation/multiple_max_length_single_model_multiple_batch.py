...
class MultipleMaxLengthSingleModelNameMultipleBatch:
    ...
    output_data = [("bfs_conn1", "token_conn1", "sub_dir1", "model1", "text 1", max_length1,
                    return_full_text, "text 1 generated" * max_length1, None)
                   ] * data_size + \
                  [("bfs_conn1", "token_conn1", "sub_dir1", "model1", "text 1", max_length2,
                    return_full_text, "text 1 generated" * max_length2, None)
                   ] * data_size
