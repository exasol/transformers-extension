...
class MultipleModelMultipleBatchIncomplete:
    ...
    tokenizer_model_output_df_model1 =  [make_model_output_for_one_input_row(number_entities=n_entities, answer=answer1,
                                                                     score=score) * \
                                                                     data_size]
    tokenizer_model_output_df_model2 =  [make_model_output_for_one_input_row(number_entities=n_entities, answer=answer2, # in first batch model is used for one input
                                                                     score=score+0.1)] + \
                                        [make_model_output_for_one_input_row(number_entities=n_entities, answer=answer2, # in second batch model is used for one input
                                                                             score=score + 0.1)]
