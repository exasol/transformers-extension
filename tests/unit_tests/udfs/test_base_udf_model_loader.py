...
from tests.unit_tests.utils.utils_for_base_udf_tests import run_test, create_mock_metadata, regex_matcher
...
def setup_model_loader_tests_and_run(bucketfs_conn_name, bucketfs_conn,
    ...
    mock_exa = create_mock_exa_environment_with_token_con(
        ...
        mock_meta,
        '',
        None)#todo do we need empty token con
