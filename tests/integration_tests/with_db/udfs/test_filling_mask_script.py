...
def test_filling_mask_script(
    ...
    print("test_filling_mask_script CURRENT_SESSION:", db_conn.execute("SELECT CURRENT_SESSION").fetchall())
    print("test_filling_mask_script CURRENT_SCHEMA:", db_conn.execute("SELECT CURRENT_SCHEMA").fetchall())
