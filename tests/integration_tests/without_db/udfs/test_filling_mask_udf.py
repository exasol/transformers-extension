...
from tests.fixtures.model_fixture import prepare_base_model_in_local_bucketfs
...
def test_filling_mask_udf(
        description, device_id, n_rows, prepare_base_model_in_local_bucketfs):
    if device_id is not None and not torch.cuda.is_available():
        pytest.skip(f"There is no available device({device_id}) "
                    f"to execute the test")

    bucketfs_base_path = prepare_base_model_in_local_bucketfs
