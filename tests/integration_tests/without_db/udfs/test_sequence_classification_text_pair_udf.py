...
from tests.fixtures.model_fixture import prepare_sequence_classification_pair_model_for_local_bucketfs
...
def test_sequence_classification_text_pair_udf(
        description, device_id, prepare_sequence_classification_pair_model_for_local_bucketfs):
