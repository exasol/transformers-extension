...
def test_ai_entailment_extended(mock_local_path, mock_create_loc, params):
    ...
    sequence_models_output_df = params.text_class_models_output_df_text_pair
