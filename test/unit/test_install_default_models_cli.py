...
from exasol_transformers_extension.install_default_models import install_default_models_command
...
def test_install_default_models_cli(
    ...
    args_string = _cli_params_to_args(cli_args) # we don't want the fixture, just the formated params
    ...
    expected_bfs_location_call = call(bucketfs_host='bfs-host',
                                      bucketfs_port=2580,
                                      bucketfs_name='bfsdefault',
                                      bucket='default',
                                      bucketfs_user='w',
