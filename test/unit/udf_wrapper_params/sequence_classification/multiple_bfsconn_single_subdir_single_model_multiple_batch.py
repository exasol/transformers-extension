...
class MultipleBucketFSConnSingleSubdirSingleModelNameMultipleBatch:
    ...
    inputs_single_text = [
        ...
        (None, "bfs_conn2", "token_conn1", "sub_dir1", "model1", "My test text")
    ] * data_size
    inputs_pair_text = [
        (
            None,
    ...
    outputs_single_text = [
        ...
        ("bfs_conn2", "sub_dir1", "model1", "My test text", "label1", 0.25, None),
        ("bfs_conn2", "sub_dir1", "model1", "My test text", "label2", 0.25, None),
        ("bfs_conn2", "sub_dir1", "model1", "My test text", "label3", 0.25, None),
        ("bfs_conn2", "sub_dir1", "model1", "My test text", "label4", 0.25, None),
    ] * data_size
