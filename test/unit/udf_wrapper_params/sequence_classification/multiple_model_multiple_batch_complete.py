...
class MultipleModelMultipleBatchComplete:
    ...
    model_output_single_text_model_1 = [make_model_output_for_one_input_row() * data_size]
    model_output_single_text_model_2 = [make_model_output_for_one_input_row() * data_size]
    sequence_models_output_df_single_text = [model_output_single_text_model_1, model_output_single_text_model_2]
    ...
    sequence_models_output_df_text_pair = [model_output_single_text_model_1, model_output_single_text_model_2]
