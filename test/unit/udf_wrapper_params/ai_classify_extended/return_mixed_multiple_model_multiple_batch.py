...
class ReturnMixedMultipleModelMultipleBatchComplete:
    """
    return_ranks is mix of HIGHEST and ALL, multiple model, multiple batches, last batch complete
    """
    ...
    zero_shot_model_output_df_model1 = [
        make_model_output_for_one_input_row(label_scores1) * batch_size
    ]
    zero_shot_model_output_df_model2 = [
        make_model_output_for_one_input_row(label_scores2) * batch_size
    ]
