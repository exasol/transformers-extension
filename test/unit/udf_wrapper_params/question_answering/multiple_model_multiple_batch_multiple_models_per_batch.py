    ...
    mock_factory = MockQuestionAnsweringFactory(
        {
            ...
            PurePosixPath(cache_dir3, "sub_dir3", "model3"): MockQuestionAnsweringModel(
                answer="answer 3", score=0.3, rank=1
            ),
            PurePosixPath(cache_dir4, "sub_dir4", "model4"): MockQuestionAnsweringModel(
                answer="answer 4", score=0.4, rank=1
            ),
        }
    )
