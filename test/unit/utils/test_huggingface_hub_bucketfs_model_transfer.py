...
class TestSetup:
    def __init__(self):
        self.bucketfs_location_mock: Union[
            BucketFSLocation, MagicMock
        ] = create_autospec(BucketFSLocation)
        self.model_factory_mock: Union[
            ModelFactoryProtocol, MagicMock
        ...
        self.bucketfs_model_uploader_mock: Union[
            BucketFSModelUploader, MagicMock
        ...
        self.downloader = HuggingFaceHubBucketFSModelTransfer(
...
def test_init():
    ...
    assert (
        ...
        == [call.create(), call.create().__enter__()]
...
def test_download():
    ...
    assert test_setup.model_factory_mock.mock_calls == [
        call.from_pretrained(
            test_setup.model_name, cache_dir=cache_dir, use_auth_token=test_setup.token
        )
    ]
