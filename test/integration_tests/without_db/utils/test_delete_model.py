...
import pytest
from exasol.python_extension_common.connections.bucketfs_location import create_bucketfs_location_from_conn_object
...
def test_delete_model(make_test_environment):
    ...
    delete_model(bucketfs_location=test_env.bucketfs_location,
