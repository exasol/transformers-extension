...
class ModelParams:
    ...
    token_model_specs: ModelSpecification       # this model is used for token classification test
    ...
    zero_shot_model_specs: ModelSpecification   # this model is used for zero-shot-classification test
...
model_params = ModelParams(
    ...
    sequence_class_model_specs=ModelSpecification(
        ...
        "text-classification"),
    sequence_class_pair_model_specs=ModelSpecification("MoritzLaurer/multilingual-MiniLMv2-L6-mnli-xnli",
                                                       "text-classification"),
    zero_shot_model_specs=ModelSpecification("MoritzLaurer/deberta-v3-xsmall-zeroshot-v1.1-all-33",
