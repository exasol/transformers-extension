...
class InstallScriptsConstants:
    ...
    def __init__(
        ...
        :param base_dir:
                base directory to install scripts from, usually
                "exasol_transformers_extension"
        :param templates_dir:
                directory containing udf templates, excluding base_dir.
                e.g "resources/templates"
