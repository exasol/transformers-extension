...
slc_parameter_formatters.set_formatter(
    CustomizableParameters.container_url, TeLanguageContainerDeployer.SLC_URL_FORMATTER
)
slc_parameter_formatters.set_formatter(
    CustomizableParameters.container_name, TeLanguageContainerDeployer.SLC_NAME
)
